...
--
-- Identical substantive content to 0011_offline_sync_idempotency.sql.
-- Timestamped copy for Supabase CLI / dashboard apply workflows.
-- =====================================================================

-- See 0011_offline_sync_idempotency.sql for full design notes.
